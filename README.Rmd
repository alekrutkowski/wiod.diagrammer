...
# Rendering this doc:
# rmarkdown::render(paste0(getwd(),'/README.Rmd'), output_format=rmarkdown::md_document(), envir=globalenv())
knitr::opts_chunk$set(echo = TRUE)
plot <- function(...) # a trick to plot svg
    wiod.diagrammer:::plot.SelectedLinksDT(...) %>% 
